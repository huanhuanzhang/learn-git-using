...
.bk-slick-header-column:hover,
.bk-slick-header-column-active {
...
.bk-data-table input[type="checkbox"] {
  margin-left: 4px;
  margin-right: 4px;
}
.bk-data-table * {
...
.bk-cell-editor input,
.bk-cell-editor select,
.bk-cell-editor .bk-ui-spinner {
  width: 100%;
  height: 100%;
  border: 0;
  margin: 0;
...
.bk-hbox {
  ...
  display: flex;
  /* safari wants it's own prefix to be happy with flex */
  display: -webkit-flex;
  flex-direction: row;
  flex-wrap: nowrap;
}
...
/*# sourceMappingURL=bokeh-widgets.css.map */
